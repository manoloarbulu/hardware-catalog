...
/// <summary>
/// Handler for GetAllComputersQuery.
/// </summary>
public class GetAllComputersQueryHandler : IRequestHandler<GetAllComputersQuery, List<ComputerDto>>
{
    private readonly ApplicationDbContext _dbContext;

    public GetAllComputersQueryHandler(ApplicationDbContext dbContext)
    {
        _dbContext = dbContext;
    }

    public async Task<List<ComputerDto>> Handle(GetAllComputersQuery request, CancellationToken cancellationToken)
    {
        var computers = await _dbContext.Computers
